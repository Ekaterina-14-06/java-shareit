...
CREATE TABLE IF NOT EXISTS reviews (
                                      ...
                                      CONSTRAINT fk_reviews_to_items FOREIGN KEY(item_id) REFERENCES items(item_id),
                                      CONSTRAINT fk_reviews_to_users FOREIGN KEY(user_id) REFERENCES users(user_id)
);